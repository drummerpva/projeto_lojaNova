...
<html>
    <head>
        ...
        <title>Nova Loja 2.0 | Dashboard</title>
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo BASE_URL; ?>" class="logo">
                    ...
                    <span class="logo-mini"><b>L</b>2.0</span>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="#">Douglas Poma</a>.</strong> Todos os direitos reservados.
            </footer>
